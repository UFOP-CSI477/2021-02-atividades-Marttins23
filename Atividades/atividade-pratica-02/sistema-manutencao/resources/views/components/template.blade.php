...
<head>
    ...
    <title> {{ $title }} - Controle de Manutenções</title>
</head>
<body>
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark justify-content-between">
        <span class="navbar-brand text-white">Controle de Manutenções</span>
            ...
            <ul class="navbar-nav mr-auto">
                @auth
                    <li class="nav-item active">
                        <a class="nav-link text-white" href="{{ route('equipamentos.index') }}">Equipamentos <span class="sr-only">(current)</span></a>
                    </li>
                @endauth
                @auth
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ route('registros.index') }}">Manutenções</a>
                    </li>
                @endauth

                @auth
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ route('relatorios.index') }}">Relatórios</a>
                    </li>
                @endauth
